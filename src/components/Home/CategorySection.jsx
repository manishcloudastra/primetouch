...
const CategorySection = () => {
    return (
        <div id="categorySection" className="px-5 py-4 mx-auto md:py-8 lg:px-32 lg:py-16 2xl:py-32">
            <div className="flex flex-wrap justify-center my-2 -m-1 md:-m-2 md:my-4 lg:my-0">
                <div className="flex flex-wrap justify-center w-1/2 2xl:w-1/3">
                    <Link href='/women'>
                        <div className="productview--img--hover relative w-full p-1 md:p-2 lg:pr-8 lg:pb-8 lg:my-2">
                    ...
                    <Link href='/men'>
                        <div className="productview--img--hover relative w-full p-1 md:px-2 md:pt-2 lg:pr-8 lg:pb-6 lg:mt-2">
                ...
                <div className="flex flex-wrap justify-center w-1/2 2xl:w-1/3">
                    <Link href='/casual'>
                        <div className="productview--img--hover relative w-full p-1 md:pl-3 md:pr-2 md:py-3 md:ml-2 lg:ml-4 lg:my-0.5">
